...
<div class="lg:text-lg md:text-base text-sm">Starts large, reduces down (more code, more bugs)</div>
```
...
<nav class="fixed bottom-0 inset-x-0 safe-area-pb bg-white border-t">Bottom nav</nav>
```
